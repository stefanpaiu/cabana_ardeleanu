    ...
    return (
        <div className="bg-bear bg-cover bg-no-repeat" id="bear-safari">
            <div className="container mx-auto py-8 px-24">
               ...
               <p className="my-8 text-4xl font-bold tracking-tight leading-none text-highlight md:text-3xl lg:text-4xl">
                   <FontAwesomeIcon icon={faCampground} size="2xl" className="text-highlight mr-8" />Bear Safari
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-1 gap-8 my-10">
                        <div className="col-span-1 mx-auto rounded-md p-4 ">
                            <div className="font-medium text-white leading-8 text-xl">Pentru a aranja sau discuta despre această experiență unică, vă rugăm să ne contactați cu cât mai în avans posibil.</div>
                        ...
                        <div className="col-span-1 font-medium text-white text-xl mx-auto rounded-md p-4">
                            <p>Cu ce venim noi:</p>
                            <ul className="list-disc">
                                ...
                                <div ><FontAwesomeIcon icon={faCircleExclamation} size="xl" className="text-highlight pr-4" />Cunoștințe avansate de silvicultură</div>
                            </ul>
                        </div>
                    </div>
                </div>
