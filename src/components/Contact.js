            ...
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <div className="grid md:grid-cols-2 sm:grid-cols-1 md:text-xl ">
                    <a href="tel:+40744266714" className="col-span-1 pb-4 md:pb-0">
                        <p className="text-paragraph font-semibold text-center md:text-left"><FontAwesomeIcon icon={faPhone} size="xl" className="text-water-blue-dark mr-8" />+40744266714</p>
                    </a>
                    <a href="mailto:robert-mihai.amarinei@unige.ch" className="col-span-1 pt-4 md:pt-0">
                        <p className="text-paragraph font-semibold text-center md:text-right"><FontAwesomeIcon icon={faEnvelope} size="xl" className="text-water-blue-dark mr-8" />robert-mihai.amarinei@unige.ch</p>
                    </a>
                </div>
            </div>
        </section>
